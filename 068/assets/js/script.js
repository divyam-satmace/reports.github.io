...
// icon.addEventListener('mapBoxContainer', function() {
...
//         if (isExpanded) {
//             $(".material-flow").removeClass("expanded");
//             $("#expandCollapseBtn").text("Expand");
//         } else {
//             $(".material-flow").addClass("expanded");
//             $("#expandCollapseBtn").text("Collapse");
//         }
...
/* $(document).ready(function () {
    ...
    $("#expandCollapseBtn").click(function () {
        var $materialFlow = $(".material-flow");

        if (isExpanded) {
            $materialFlow.removeClass("expanded");
            $("#expandCollapseBtn").text("Expand");
        } else {
            $materialFlow.addClass("expanded");
            $("#expandCollapseBtn").text("Collapse");
        }
...
/* document.addEventListener("DOMContentLoaded", function () {
    var isExpanded = false;
    var expandCollapseBtn = document.getElementById("expandCollapseBtn");
    var materialFlow = document.querySelectorAll(".material-flow")[0];

    expandCollapseBtn.addEventListener("click", function () {
        if (isExpanded) {
            materialFlow.classList.remove("expanded");
            expandCollapseBtn.textContent = "Expand";
        } else {
            materialFlow.classList.add("expanded");
