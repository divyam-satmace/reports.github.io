...
var markers = [
    {
        lngLat: [26.421075, 73.983872],
        popupContent: '<h3>Dumalav, Gujarat </h3><p>Collection centre</p>',
    ...
    {
        lngLat: [20.235879, 72.791443],   //769DFA
...
markers.forEach(function (markerInfo) {
    ...
    // var popup = new mapaboxgl.Popup({ className: 'marker-popup' }).setHTML(markerInfo.popupContent);
...
map3.on('load', function () {
    ...
    var destinations = [
        [72.9968 , 20.50095 ],   //74.468330, 21.545584
        // [77.410506, 13.289093],      //74.5089, 20.5579
        // [73.243896, 22.264793],
